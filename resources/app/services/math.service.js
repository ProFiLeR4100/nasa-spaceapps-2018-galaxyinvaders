...
function MathService() {
    ...
    factory.Deg2Rad = (Math.PI * 2) / FULL_ANGLE;
    factory.Epsilon = Number.EPSILON || EPSILON;
    factory.NegativeInfinity = -Infinity;
    factory.Rad2Deg = FULL_ANGLE / (Math.PI * 2);
     ...
     * @returns {boolean}
     */
    factory.approximately = function(f1, f2) {
        return Math.abs(f1 - f2) < factory.Epsilon;
    };
     ...
     * @returns {number}
     */
    factory.clamp = function(value, min, max) {
     ...
     * @returns {number}
     */
    factory.clamp01 = function(value) {
     ...
     * @returns {number}
     */
    factory.closestPowerOfTwo = function(value) {
        var nextPowerOfTwo = factory.nextPowerOfTwo(value);
     ...
     * @returns {number}
     */
    factory.closestPowerOfTwoLong = function(value) {
        value = toInt(value);

        if (value < 0) return 0;

        // algorithm to find next power of two for long integers
        var nextPowerOfTwo = 2 << Math.floor(Math.log2(value));
     ...
     * @returns {number}
     */
    factory.deltaAngle = function(current, target) {
     ...
     * @returns {number}
     */
    factory.gammaToLinearSpace = function(value) {
     ...
     * @returns {number}
     */
    factory.inverseLerp = function(a, b, value) {
        return (factory.clamp(value, Math.min(a, b), Math.max(a, b)) - a) / (b - a);
    };
     ...
     * @returns {boolean}
     */
    factory.isPowerOfTwo = function(value) {
        value = toInt(value);
     ...
     * @returns {number}
     */
    factory.lerp = function(a, b, t) {
        return (b - a) * factory.clamp01(t) + a;
    };
     ...
     * @returns {number}
     */
    factory.lerpAngle = function(a, b, t) {
     ...
     * @returns {number}
     */
    factory.lerpUnclamped = function(a, b, t) {
        if (t < 0 || t > 1) {
     ...
     * @returns {number}
     */
    factory.linearToGammaSpace = function(value) {
     ...
     * @returns {number}
     */
    factory.moveTowards = function(current, target , maxDelta) {
        if (maxDelta > 0) {
     ...
     * @returns {number}
     */
    factory.moveTowardsAngle = function(current, target, maxDelta) {};
     ...
     * @returns {number}
     */
    factory.nextPowerOfTwo = function(value) {
        value = toInt(value);
     ...
     * @returns {number}
     */
    factory.perlinNoise = function(x, y) {
     ...
     * @returns {number}
     */
    factory.pingPong = function(t, length) {
        if (t < 0) t = -t;
        var mod = t % length;
        // if mod is even
     ...
     * @returns {number}
     */
    factory.repeat = function(t, length) {
     ...
     * @returns {number}
     */
    factory.round = function(f) {
        var ceilVal = f + IS_INTEGER;
     ...
     * @returns {number}
     */
    factory.smoothDamp = function(current, target, currentVelocity, smoothTime, maxSpeed, deltaTime) {};
     ...
     * @returns {number}
     */
    factory.smoothDampAngle = function(current, target, currentVelocity, smoothTime, maxSpeed, deltaTime) {};
     ...
     * @returns {number}
     */
    factory.smoothStep = function(a, b, t) {};
